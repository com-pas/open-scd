import '../../../common/lit-html-4dfc8767.js';
import { i as i$2, s } from '../../../common/lit-element-e8edc630.js';
import { h as html, n as nothing } from '../../../common/lit-html-4eb216a4.js';
import { u, i as i$4 } from '../../../common/static-e9081a0a.js';
import { _ as __decorate } from '../../../common/tslib.es6-98fe39c2.js';
import { c as e, i as i$3, t, d as E, A, m as mixinDelegatesAria, n as n$1, r as r$1, e as e$1, a as e$2, E as EASING } from '../../../common/delegate-05546eff.js';
import { o as o$1 } from '../../../common/query-assigned-elements-e9fd2743.js';
import { r as redispatchEvent } from '../../../common/redispatch-event-275085a6.js';
import { V as Validator, m as mixinConstraintValidation, a as mixinFormAssociated, g as getFormValue, c as createValidator, d as getValidityAnchor } from '../../../common/validator-c9555f59.js';
import { i as internals, m as mixinElementInternals } from '../../../common/element-internals-ec6d8159.js';
import { S as ScopedElementsMixin } from '../../../common/lit-element-36e0e222.js';
import { r as render } from '../../../common/render-4cc4e0f1.js';
 ...
 */
const a=Symbol.for(""),i=(t,...r)=>({_$litStatic$:r.reduce((r,e,a)=>r+(t=>{if(void 0!==t._$litStatic$)return t._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${t}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(e)+t[a+1],t[0]),r:a});
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const l=e(class extends i$3{constructor(r$1){if(super(r$1),r$1.type!==t.PROPERTY&&r$1.type!==t.ATTRIBUTE&&r$1.type!==t.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!r(r$1))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(i,[t$1]){if(t$1===E||t$1===A)return t$1;const o=i.element,l=i.name;if(i.type===t.PROPERTY){if(t$1===o[l])return E}else if(i.type===t.BOOLEAN_ATTRIBUTE){if(!!t$1===o.hasAttribute(l))return E}else if(i.type===t.ATTRIBUTE&&o.getAttribute(l)===t$1+"")return E;return p(i),t$1}});

/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const n="important",i$1=" !"+n,o=e(class extends i$3{constructor(t$1){if(super(t$1),t$1.type!==t.ATTRIBUTE||"style"!==t$1.name||t$1.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,r)=>{const s=t[r];return null==s?e:e+`${r=r.includes("-")?r:r.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(e,[r]){const{style:s}=e.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(r)),this.render(r);for(const t of this.ft)null==r[t]&&(this.ft.delete(t),t.includes("-")?s.removeProperty(t):s[t]=null);for(const t in r){const e=r[t];if(null!=e){this.ft.add(t);const r="string"==typeof e&&e.endsWith(i$1);t.includes("-")||r?s.setProperty(t,r?e.slice(0,-11):e,r?n:""):s[t]=e;}}return E}});
...
const textFieldBaseClass = mixinDelegatesAria(mixinOnReportValidity(mixinConstraintValidation(mixinFormAssociated(mixinElementInternals(s)))));
/**
...
class TextField extends textFieldBaseClass {
    ...
    renderAffix(text, isSuffix) {
        ...
        return html `<span class="${e$2(classes)}">${text}</span>`;
    }
    getErrorText() {
...
OscdFilledField.styles = [styles$3, styles$2];
...
class OscdFilledTextField extends ScopedElementsMixin(FilledTextField) {
    constructor() {
        super(...arguments);
        this.fieldTag = i `oscd-filled-field`;
    }
}
OscdFilledTextField.styles = [styles$1, styles];
