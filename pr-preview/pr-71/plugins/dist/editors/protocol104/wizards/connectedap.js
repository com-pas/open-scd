...
import '../../../../../_snowpack/pkg/@omicronenergy/oscd-ui/checkbox/oscd-checkbox.js';
import '../../../../../_snowpack/pkg/@omicronenergy/oscd-ui/switch/oscd-switch.js';
...
import '../../../../../_snowpack/pkg/@compas-oscd/open-scd/dist/filtered-list.js';
import { pTypes104, stationTypeOptions, typeDescriptiveNameKeys, typePattern, } from '../foundation/p-types.js';
import { compareNames, getValue, identity, isPublic, newSubWizardEvent, newWizardEvent, } from '../../../../../_snowpack/pkg/@compas-oscd/open-scd/dist/foundation.js';
import { cloneElement, createElement } from '../../../../../_snowpack/pkg/@compas-oscd/xml.js';
          ...
          ${redundancy
                ...
                <oscd-list>
                  ${redundancyGroupNumbers.length != 0
                        ? redundancyGroupNumbers.map(number => html `<oscd-list-item type="button"
                              @click=${(e) => {
                            e.target.dispatchEvent(newSubWizardEvent(() => editRedundancyGroupWizard(parent, number)));
                        }}
