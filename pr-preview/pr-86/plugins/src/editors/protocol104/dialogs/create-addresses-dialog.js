...
export let CreateAddressesDialog = class extends BaseDialog {
  constructor() {
    super(...arguments);
    this.doElement = null;
    this.lnElement = null;
  ...
  setMonitorControlValue(selected, isMonitor) {
    ...
    availableTis.maybeValue = isMonitor ? selected === "30" ? "58" : "62" : selected === "58" ? "30" : "35";
  }
...
__decorate([
  state()
], CreateAddressesDialog.prototype, "doElement", 2);
__decorate([
  state()
], CreateAddressesDialog.prototype, "lnElement", 2);
