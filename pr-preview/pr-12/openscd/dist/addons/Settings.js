...
import { newLogEvent, newLoadNsdocEvent } from '../../../_snowpack/link/packages/core/dist/index.js';
...
let OscdSettings = class OscdSettings extends LitElement {
    ...
    getSetting(setting) {
        return (localStorage.getItem(String(setting)) ?? defaults[setting]);
    }
    /** Update the `value` of `setting`, storing to `localStorage`. */
    setSetting(setting, value) {
        localStorage.setItem(String(setting), value);
        this.shadowRoot
