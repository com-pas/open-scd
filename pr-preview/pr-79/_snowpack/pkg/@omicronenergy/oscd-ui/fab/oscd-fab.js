...
import { m as mixinDelegatesAria, n, a as e } from '../../../common/delegate-05546eff.js';
...
const fabBaseClass = mixinDelegatesAria(s);
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const styles$2 = i `@media(forced-colors: active){.fab{border:1px solid ButtonText}.fab.extended{padding-inline-start:15px;padding-inline-end:19px}md-focus-ring{--md-focus-ring-outward-offset: 3px}}
`;
 ...
 * @suppress {visibility}
 */
class OscdFab extends ScopedElementsMixin(Fab) {
}
OscdFab.scopedElements = {
