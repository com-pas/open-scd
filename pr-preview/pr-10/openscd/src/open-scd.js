...
import {newOpenDocEvent, newPendingStateEvent} from "../../_snowpack/link/packages/core/dist/index.js";
...
import {OscdApi, XMLEditor, newLogEvent} from "../../_snowpack/link/packages/core/dist/index.js";
...
export let OpenSCD = class extends LitElement {
  ...
  connectedCallback() {
    ...
    this.loadPlugins();
    this.unsubscribers.push(this.editor.subscribe((_e) => this.editCount++), this.editor.subscribeUndoRedo((_e) => this.editCount++));
...
function withoutContent(plugin) {
  const {content, ...rest} = plugin;
  return {...rest, content: void 0};
}
