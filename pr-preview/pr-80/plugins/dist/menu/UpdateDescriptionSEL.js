...
import { css, LitElement, query, html } from '../../../_snowpack/pkg/lit-element.js';
...
import { find, identity, isPublic, newWizardEvent, } from '../../../_snowpack/pkg/@compas-oscd/open-scd/dist/foundation.js';
    ...
    return [
        {
          ...
          >${Array.from(items.map(item => oscdHtml `<mwc-check-list-item
                  twoline
                  selected
