import './lit-element-5461ae81.js';
import { h as html, s as svg } from './lit-html-4eb216a4.js';
...
const reportIcon = svg `<svg style="width:24px;height:24px" viewBox="0 0 24 24">${pathsSVG['reportIcon']}</svg>`;
const smvIcon = svg `<svg style="width:24px;height:24px" viewBox="0 0 24 24">${pathsSVG['smvIcon']}</svg>`;
const logIcon = svg `<svg style="width:24px;height:24px" viewBox="0 0 24 24">${pathsSVG['logIcon']}</svg>`;
const controlBlockIcons = {
    ReportControl: reportIcon,
    LogControl: logIcon,
    GSEControl: gooseIcon,
    SampledValueControl: smvIcon,
};
const inputIcon = svg `<svg style="width:24px;height:24px" viewBox="0 0 24 24">
<path fill="currentColor" d="M14,12L10,8V11H2V13H10V16M20,18V6C20,4.89 19.1,4 18,4H6A2,2 0 0,0 4,6V9H6V6H18V18H6V15H4V18A2,2 0 0,0 6,20H18A2,2 0 0,0 20,18Z" />
</svg>`;
const clientIcon = svg `<svg style="width:24px;height:24px" viewBox="0 0 24 24">
...
const voltageLevelIcon = html `<svg
  id="Laag_1"
  data-name="Laag 1"
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
...
const disconnectorIcon = html `<svg
  id="Laag_1"
  data-name="Laag 1"
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
...
const currentTransformerIcon = html `<svg
  id="Laag_1"
  data-name="Laag 1"
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
...
const voltageTransformerIcon = html `<svg
  id="Laag_1"
  data-name="Laag 1"
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
...
const earthSwitchIcon = html `<svg
  id="Laag_1"
  data-name="Laag 1"
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
...
const generalConductingEquipmentIcon = html `<svg
  id="Laag_1"
  data-name="Laag 1"
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
...
const connectivityNodeIcon = html `<svg
  xmlns="http://www.w3.org/2000/svg"
>
  <circle
    stroke="currentColor"
...
const powerTransformerTwoWindingIcon = html `<svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 25 25"
>
  <line
...
const lineIcon = svg `<svg id="Laag_1" data-name="Laag 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
<defs>
  <style>
    .cls-1 {
      fill: currentColor;
...
const processIcon = svg `<svg id="Laag_1" data-name="Laag 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
<defs>
  <style>
    .cls-1 {
      fill: currentColor;
...
const transformerWindingIcon = svg `<svg id="Laag_1" data-name="Laag 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
<defs>
  <style>
    .cls-1 {
      fill: currentColor;
...
export { currentTransformerIcon as a, bayIcon as b, circuitBreakerIcon as c, disconnectorIcon as d, voltageTransformerIcon as e, earthSwitchIcon as f, generalConductingEquipmentIcon as g, gooseIcon as h, smvIcon as i, getIcon as j, clientIcon as k, lineIcon as l, controlBlockIcons as m, inputIcon as n, openSCDIcon as o, processIcon as p, getFilterIcon as q, dataTypeTemplateIcons as r, substationIcon as s, sizableGooseIcon as t, sizableSmvIcon as u, voltageLevelIcon as v, connectivityNodeIcon as w, editIcon as x, powerTransformerTwoWindingIcon as y, transformerWindingIcon as z };
